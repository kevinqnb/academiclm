...
identification_prompt = (
    "You are an expert in identifying tropical forests referenced in text from scientific literature. "
    "Using the given context, find, identify, and list all tropical forests it mentions. "
)
...
class MeasurementSchema(BaseModel):
    carbon_sequestration: float | None = Field(
        description="Total mass of carbon captured and stored.",
        json_schema_extra={'units': ["t C / yr", "t CO₂ / yr"]}
    )
